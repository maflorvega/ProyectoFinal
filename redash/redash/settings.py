...
DATABASE_CONFIG = parse_db_url(os.environ.get("REDASH_DATABASE_URL", "postgresql://root:Devspark15@prod-mg-redash-rds.ctlhckwxvix2.us-east-1.rds.amazonaws.com:5432/redash"))
...
HOST = os.environ.get('REDASH_HOST', 'dashboard.mansionglobal.com')
